...
<div align="left">
	<h2 align="center" style="font-weight: 800; display: flex; gap: 4px; align-items: center; justify-content: center">
		<img
			src="https://raw.githubusercontent.com/ImRoodyDev/imroodydev/main/img/info-solid-full.svg"
			alt="info icon"
			height="28"
		/>
		Things about me
...
<div style="margin: 40px 0">
	<h2 align="center" style="font-weight: 800; display: flex; gap: 4px; align-items: center; justify-content: center">
		<img
			src="https://raw.githubusercontent.com/ImRoodyDev/imroodydev/main/img/chart-pie-solid-full.svg"
			alt="stats icon"
			height="28"
		/>
		GitHub Stats
...
<h2 align="center" style="font-weight: 800; display: flex; gap: 4px; align-items: center; justify-content: center">
	<img
		src="https://raw.githubusercontent.com/ImRoodyDev/imroodydev/main/img/code-solid-full.svg"
		alt="code icon"
		height="28"
	/>
	Things I code with
...
<div align="center" style="max-width: 60%; display: flex; flex-direction: column; margin: 0 auto">
	...
	<p align="center" style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 8px; justify-content: center">
		<img
			style="border-radius: 12px; overflow: hidden; height: 22px"
		...
		<img
			style="border-radius: 12px; overflow: hidden; height: 22px"
			src="https://img.shields.io/badge/vite-%23646CFF.svg?style=flat-square&logo=vite&logoColor=white"
			alt="Vite"
		/>
		<img
			style="border-radius: 12px; overflow: hidden; height: 22px"
    ...
    <p align="center" style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 8px; justify-content: center">
    	...
    	<img
    		style="border-radius: 12px; overflow: hidden; height: 22px"
    		src="https://img.shields.io/badge/ejs-%23B4CA65.svg?style=flat-square&logo=ejs&logoColor=black"
    		alt="EJS"
    	/>
    	<img
    		style="border-radius: 12px; overflow: hidden; height: 22px"
    ...
    <p align="center" style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 8px; justify-content: center">
    	...
    	<img
    		style="border-radius: 12px; overflow: hidden; height: 22px"
    		src="https://img.shields.io/badge/.NET-5C2D91?style=flat-square&logo=.net&logoColor=white"
    		alt=".NET"
    	/>
    </p>
